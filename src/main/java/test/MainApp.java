...
public static void loadForgotPasswordUI(String email) {
    try {
        URL fxmlUrl = MainApp.class.getResource("/views/forgot_password.fxml");
        if (fxmlUrl == null) {
            LOGGER.log(Level.SEVERE, "Cannot find /views/forgot_password.fxml");
            throw new IllegalStateException("Required FXML file not found: /views/forgot_password.fxml");
        }
        ...
        if (email != null && !email.isEmpty()) {
            controllers.ForgotPasswordController controller = loader.getController();
