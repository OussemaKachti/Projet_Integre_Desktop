    ...
    private VBox createSeasonCard(Saison season) {
        ...
        try {
            ...
            if (seasonIcon.getImage() == null || seasonIcon.getImage().isError()) {
                seasonIcon.setImage(new Image(getClass().getResourceAsStream("/com/esprit/images/default.PNG")));
            }
        } catch (Exception e) {
                    ...
                    try {
                        ...
                        if (logoPath != null && !logoPath.isEmpty()) {
                            ...
                            if (logoFile.exists()) {
                                ...
                                logoView.setImage(new Image(getClass().getResourceAsStream("/com/esprit/images/club_placeholder.png")));
                            }
                        } else {
                            logoView.setImage(new Image(getClass().getResourceAsStream("/com/esprit/images/club_placeholder.png")));
                        }
