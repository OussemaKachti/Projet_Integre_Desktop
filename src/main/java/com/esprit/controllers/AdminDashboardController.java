...
public class AdminDashboardController {
    ...
    // private final ProfanityLogManager modelsger = new ProfanityLogManager();
    ...
    private void showUserDetails(User user) {
        ...
        if (user.getWarningCount() > 0) {
            ...
            // modelsger.getProfanityIncidents(user.getId());
            ...
            // } else {
            // Label explanationLabel = new Label("The following violations have been
            // detected and logged:");
            ...
            // incidentBox.setStyle("-fx-border-color: #FFE0B2; -fx-border-radius: 5;
            // -fx-padding: 8;");
            ...
            // incidentBox.getChildren().addAll(dateLabel, fieldLabel, severityLabel,
            // actionLabel);
