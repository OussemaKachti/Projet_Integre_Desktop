...
public class ProfanityLogManager {
     ...
     * @return True if the incident was logged and warning count incremented, false
     *         otherwise
     */
    public static boolean logProfanityIncident(User user, String fieldName, String profaneText, String severity,
            String action) {
    ...
    private static String censorProfanity(String text) {
        ...
        // Create a simple partial censoring by replacing middle characters with
        // asterisks
